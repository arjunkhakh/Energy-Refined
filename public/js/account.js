...
//         .val()
//         .trim()
//         .match(/^[a-zA-Z0-9 _-]{6,15}$/)
//     ) {
//       errors = true
//       errorArray.push(
//         "'Username' field must be from 6 to 15 characters with no special characters!"
//       )
//     }
//     if (
//       $('#update-password')
...
//         errors = true
//         errorArray.push(
//           "'Password' field must be from 6 to 15 characters with no special characters!"
//         )
//       }
//     }
//     if (
